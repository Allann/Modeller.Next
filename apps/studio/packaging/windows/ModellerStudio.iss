...
#define AppExeName "ModellerStudio.vbs"
...
Root: HKCR; Subkey: "ModellerStudio.WorkspacePackage\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\ModellerStudio.cmd,0"
Root: HKCR; Subkey: "ModellerStudio.WorkspacePackage\shell\open\command"; ValueType: string; ValueName: ""; ValueData: "wscript.exe ""{app}\{#AppExeName}"" ""%1"""
