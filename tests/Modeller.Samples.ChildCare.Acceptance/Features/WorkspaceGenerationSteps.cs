...
public sealed class WorkspaceGenerationSteps
{
    ...
    public void GivenTheNonChargeableReasonHasBeenAddedToTheSampleWorkspace(string reasonName)
    {
        ...
        _host = new RecordingCliHost(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ["samples/child-care/.modeller/config.json"] = """
                ...
                """,
            ["samples/child-care/model/child-care.modeller"] = $"""
                rml 1.0
                context Child Care
                  version 1.0.0
                end
            ...
            ["samples/child-care/.modeller/identities.json"] = """
                { "version":"1.0", "documents": { "model/child-care.modeller": [
                  ...
                  "0191f6d4-4ea0-7000-8000-000000000002", "0191f6d4-4ea0-7000-8000-000000000003",
                  "0191f6d4-4ea0-7000-8000-000000000004", "0191f6d4-4ea0-7000-8000-000000000005",
                  "0191f6d4-4ea0-7000-8000-000000000006", "0191f6d4-4ea0-7000-8000-000000000007",
                  "0191f6d4-4ea0-7000-8000-000000000008" ] } }
                """,
