...
| --- | --- | --- |
| Domain definition parsing | Parser, DSL reference, tests, and Child Care samples | `Modeller.Parsing`: SAF 1.0, canonical compilation, source diagnostics, and an explicit legacy-root adapter |
